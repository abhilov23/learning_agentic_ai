...
# few-shot prompt to select the correct research assistant for a given question, and to return the instructions for that assistant.
...
# WEB_SEARCH_INSTRUCTIONS : few-shot prompt to generate web search queries based on a question and the instructions of the selected research assistant. 
...
# SUMMARY_INSTRUCTIONS : few-shot prompt to generate a summary of a web search result, based on the question and the instructions of the selected research assistant. If the question cannot be answered based on the search result, then the response should be a summary of the search result.
